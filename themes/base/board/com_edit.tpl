<table class="forum" style="width:{page:width}" cellpadding="0" cellspacing="{page:cellspacing}">
  <tr>
    <td class="headb">{lang:board} - {lang:head_com_edit}</td>
  </tr>
  <tr>
    <td class="leftc">
        {head:links}    
...
<form method="post" id="board_com_edit" action="{url:board_com_edit}" enctype="multipart/form-data">
<table class="forum" style="width:{page:width}" cellpadding="0" cellspacing="{page:cellspacing}">
  <tr>
  ...
  <tr>
    ...
    <td class="leftb">
      ...
      {files:ext} {files:name}<br />
        {if:del_button}<input type="submit" class="button" class="button danger" name="remove_file_{files:num}" value="{lang:remove}" />{stop:del_button}
        {files:file_del}
      <!--  </div>  -->
