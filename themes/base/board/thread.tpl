          ...
          <div style="padding: 3px;">
            ...
            <form method="post" id="thread_vote" action="{url:board_thread:where={thread:threads_id}}">
              ...
              <div style="margin-top: 10px;">
                ...
                <input type="submit" class="button" name="submit_v" value="{lang:vote}" />
              </div>
            </form>
          </div>
        </div>
  ...
  <table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
    <tr>
      <td class="centerb"><div class="button-group"> {if:modp_close}
        ...
        {stop:modp_close}
        {if:modp_open}
        <input type="submit" class="button" name="open" value="{lang:thread_open}" />
        {stop:modp_open}
        {if:modp_delpin}
        <input type="submit" class="button" name="delpin" value="{lang:thread_delpin}" />
        {stop:modp_delpin}
        {if:modp_addpin}
        <input type="submit" class="button" name="addpin" value="{lang:thread_addpin}" />
        {stop:modp_addpin}
...
<form method="post" id="board_com_create" action="{url:board_com_create}">
  <table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
    <tr>
      <td class="leftc" colspan="2"><input type="submit" class="button" name="advanced" value="{lang:adv_com}" />
      </td>
    </tr>
    <tr>
