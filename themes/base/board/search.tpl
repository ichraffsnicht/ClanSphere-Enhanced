...
<table class="forum" style="width:{page:width}" cellpadding="0" cellspacing="{page:cellspacing}">
  ...
  <tr>
    ...
    <td class="leftc">
      <input type="submit" class="button" name="search" value="{lang:search}" />
    </td>
  </tr>
</table>
</form>
...
<table class="forum" style="width:{page:width}" cellpadding="0" cellspacing="{page:cellspacing}">
  <tr>
    ...
    <td class="centerb">
      <input type="submit" class="button" name="first" value="&lt;&lt;" />
      <input type="submit" class="button" name="back" value="&lt;" />
      <input type="submit" class="button" name="next" value="&gt;" />
      <input type="submit" class="button" name="last" value="&gt;&gt;" />
    </td>
