<table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
  ...
  <tr>
    <td class="leftb" style="width:50%"><a href="{link:board}" class="button">{lang:board}</a> <a href="{link:name}" class="button icon arrow-right">{categories:name}</a> <span class="button icon arrow-bottom disable">{board:name}</span></td>
    <td class="rightb" style="width:50%">{if:newthread}<a href="{link:newthread}" class="button icon pencil">{lang:newthread}</a>{stop:newthread} </td>
  </tr>
  <tr>
    <td class="rightc" colspan="2"><a href="{link:mark_board}" class="button danger">{lang:mark_board}</a> </td>
  </tr>
</table>
<br />
<table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
  ...
  <tr>
    <td class="rightc" colspan="5"><a href="{link:mark_board}" class="button danger">{lang:mark_board}</a>  </td>
  </tr>
</table>
<br />
{board:statistik}