...
<table class="forum" style="width: {page:width}" cellpadding="0" cellspacing="{page:cellspacing}">
  ...
  <tr>
    ...
    <td class="leftb">
      ...
      <input type="submit" class="button" name="submit" value="{lang:upload}" />{if:modsdir}
      <input type="submit" class="button" name="accessadd" value="{lang:entry_in_accessfile}" />{stop:modsdir}</td>
  </tr>
</table>
</form>
