...
<form method="post" id="users_profile" action="{form:action}">
  <table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width};">
    ...
    <tr>
      ...
      <td class="leftb"><input type="text" name="users_msn" value="{users:users_msn}" maxlength="40" size="40" /></td>
    ...
    <tr>
      ...
      <td class="leftb" colspan="2"><input type="submit" class="button" name="submit" value="{lang:edit}" />
              </td>
    </tr>
  </table>
</form>
