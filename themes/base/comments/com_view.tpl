  ...
  <tr>
    ...
    <td class="{com:class}"> # {com:current} - {com:comments_time}<a href="#" id="com{com:run}"></a>
      ...
      <div style="float:right">
        <input type="submit" class="button" name="fquote" value="{com:id}" style="width:16px;height:16px;background:url({page:path}{fquote:icon});border:none;cursor:pointer;padding:0px;font-size:0px;" />
