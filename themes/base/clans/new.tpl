...
<br />
<form method="post" id="clans_new" action="{url:clans_new}" enctype="multipart/form-data">
  <table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
    <tr>
  ...
  <tr>
    ...
    <tr>
      ...
      <td class="leftb"><input type="submit" class="button" name="submit" value="{lang:create}" />
              </td>
    </tr>
  </table>
</form>
