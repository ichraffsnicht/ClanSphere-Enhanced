<table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
  <tr>
    <td class="headb" colspan="5">{lang:mod_name} - {lang:head_center_msg}</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <form method="post" id="messages_filter" action="{url:messages_inbox}">
     ...
     </select> <input type="submit" class="button" name="submit" value="{lang:show}" /></form>
    </td>
  </tr>
</table>
<br />
...
<table class="forum" cellpadding="0" cellspacing="{page:cellspacing}" style="width:{page:width}">
  ...
  <tr>
    <td class="rightb" colspan="7">
      ...
      <input type="submit" class="button" name="submit" value="{lang:remove_selected}" />
