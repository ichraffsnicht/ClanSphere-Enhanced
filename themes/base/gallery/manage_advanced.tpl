...
<table class="forum" style="width:{page:width}" cellpadding="0" cellspacing="{page:cellspacing}">
  ...
  <tr>
    ...
    <td class="leftb"><input type="submit" class="button" name="submit" value="{lang:continue}" /></td>
  </tr>
</table>
{stop:start}
...
<table class="forum" style="width:{page:width}" cellpadding="0" cellspacing="{page:cellspacing}">
  ...
  <tr>
    ...
    <td class="leftc">
      ...
      <input type="submit" class="button" name="submit_zipfile" value="{lang:continue}" />
    </td>
  </tr>
</table>
{stop:zipfile}
...
<table class="forum" style="width:{page:width}" cellpadding="0" cellspacing="{page:cellspacing}">
  ...
  <tr>
    <td class="leftc">{icon:ksysguard} {lang:options}</td>
    <td class="leftb" colspan="3">
      <input type="submit" class="button" name="submit_1" value="{lang:continue}" />
    </td>
  </tr>
</table>
<br />
